...
// Source: com/google/transit/realtime/gtfs-realtime-NYCT.proto.txt
//
...
public struct TransitRealtime_TripReplacementPeriod: Sendable {
  ...
  public var hasReplacementPeriod: Bool {return self._replacementPeriod != nil}
...
public struct TransitRealtime_NyctFeedHeader: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var tripReplacementPeriod: [TransitRealtime_TripReplacementPeriod] = []
...
public struct TransitRealtime_NyctTripDescriptor: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
  ...
  public var direction: TransitRealtime_NyctTripDescriptor.Direction {
...
public struct TransitRealtime_NyctStopTimeUpdate: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.
...
// MARK: - Extension support defined in gtfs-realtime-NYCT.proto.txt.
...
extension TransitRealtime_FeedHeader {
  ...
  public var TransitRealtime_nyctFeedHeader: TransitRealtime_NyctFeedHeader {
  ...
  public var hasTransitRealtime_nyctFeedHeader: Bool {
  ...
  public mutating func clearTransitRealtime_nyctFeedHeader() {
...
extension TransitRealtime_TripDescriptor {
  ...
  public var TransitRealtime_nyctTripDescriptor: TransitRealtime_NyctTripDescriptor {
  ...
  /// has been explicitly set.
  public var hasTransitRealtime_nyctTripDescriptor: Bool {
  ...
  /// Subsequent reads from it will return its default value.
  public mutating func clearTransitRealtime_nyctTripDescriptor() {
...
extension TransitRealtime_TripUpdate.StopTimeUpdate {
  ...
  public var TransitRealtime_nyctStopTimeUpdate: TransitRealtime_NyctStopTimeUpdate {
  ...
  /// has been explicitly set.
  public var hasTransitRealtime_nyctStopTimeUpdate: Bool {
  ...
  /// Subsequent reads from it will return its default value.
  public mutating func clearTransitRealtime_nyctStopTimeUpdate() {
    clearExtensionValue(ext: TransitRealtime_Extensions_nyct_stop_time_update)
  }

}

// MARK: - File's ExtensionMap: TransitRealtime_Gtfs_u45Realtime_u45Nyct_u46Proto_Extensions

/// A `SwiftProtobuf.SimpleExtensionMap` that includes all of the extensions defined by
/// this .proto file. It can be used any place an `SwiftProtobuf.ExtensionMap` is needed
/// in parsing, or it can be combined with other `SwiftProtobuf.SimpleExtensionMap`s to create
/// a larger `SwiftProtobuf.SimpleExtensionMap`.
public let TransitRealtime_Gtfs_u45Realtime_u45Nyct_u46Proto_Extensions: SwiftProtobuf.SimpleExtensionMap = [
...
public let TransitRealtime_Extensions_nyct_feed_header = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<TransitRealtime_NyctFeedHeader>, TransitRealtime_FeedHeader>(
  _protobuf_fieldNumber: 1001,
  fieldName: "transit_realtime.nyct_feed_header"
)

public let TransitRealtime_Extensions_nyct_trip_descriptor = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<TransitRealtime_NyctTripDescriptor>, TransitRealtime_TripDescriptor>(
  _protobuf_fieldNumber: 1001,
  fieldName: "transit_realtime.nyct_trip_descriptor"
)

public let TransitRealtime_Extensions_nyct_stop_time_update = SwiftProtobuf.MessageExtension<SwiftProtobuf.OptionalMessageExtensionField<TransitRealtime_NyctStopTimeUpdate>, TransitRealtime_TripUpdate.StopTimeUpdate>(
  _protobuf_fieldNumber: 1001,
...
extension TransitRealtime_TripReplacementPeriod: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".TripReplacementPeriod"
  ...
  public static func ==(lhs: TransitRealtime_TripReplacementPeriod, rhs: TransitRealtime_TripReplacementPeriod) -> Bool {
...
extension TransitRealtime_NyctFeedHeader: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NyctFeedHeader"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: TransitRealtime_NyctFeedHeader, rhs: TransitRealtime_NyctFeedHeader) -> Bool {
...
extension TransitRealtime_NyctTripDescriptor: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NyctTripDescriptor"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: TransitRealtime_NyctTripDescriptor, rhs: TransitRealtime_NyctTripDescriptor) -> Bool {
...
extension TransitRealtime_NyctStopTimeUpdate: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".NyctStopTimeUpdate"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  public static func ==(lhs: TransitRealtime_NyctStopTimeUpdate, rhs: TransitRealtime_NyctStopTimeUpdate) -> Bool {
